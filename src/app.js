...
function classifyMove(ctx) {
  ...
  // Brilhante: sacrifício correto (retomada obrigatória não conta)
  if (legal > 1 && !recaptura && loss <= BRI.perdaMax) {
...
function classify(i) {
  ...
  const cls = classifyMove({
    ...
    recaptura: !!(mv.captured && anterior && anterior.captured && anterior.to === mv.to),
  });
